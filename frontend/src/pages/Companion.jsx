      ...
      try {
        ...
        if (data.messages && data.messages.length > 0) {
          ...
          setMessages([
            {
              role: 'assistant',
              content: `Hi ${userProfile?.profile?.name || 'there'}! I'm your AI companion on 3Degrees. I'm here to chat, learn about you, and help you make meaningful connections. What's on your mind today?`,
